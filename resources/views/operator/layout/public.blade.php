...
<head>
    ...
    <title>TollLater (Operator) - @yield('title')</title>
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">TollLater <span class="badge bg-warning text-dark">Operator</span></a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link @if($station) active @endif" href="/operator/stations">
                                Manage Toll Stations
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if($report) active @endif" href="/operator/reports">
                                Transaction Report
                            </a>
                        </li>
                    </ul>
